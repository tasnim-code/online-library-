...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>انشاء حساب الان</h3>
      <input type="text" name="name" required placeholder="ادحل اسم الخاص بك" maxlength="20"  class="box">
      ...
      <input type="password" name="cpass" required placeholder=" تاكيد كلمة السر" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="submit" value="سجل الان" class="btn" name="submit">
      <p>هل لديك حساب؟</p>
      <a href="user_login.php" class="option-btn">سجل دخول الان</a>
   </form>
